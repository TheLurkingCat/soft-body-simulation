...
namespace graphics {
namespace {
constexpr int nFilled = 6 * g_SphereStacks * g_SphereSectors - 6 * g_SphereStacks;
constexpr int nWire = 4 * g_SphereStacks * g_SphereSectors - 2 * g_SphereStacks;
}  // namespace
...
Sphere::Sphere(RenderMode m) : mode(m) {
